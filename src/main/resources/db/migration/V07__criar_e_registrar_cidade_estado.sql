...
ALTER TABLE pessoa ADD COLUMN endereco_codigo_cidade BIGINT(20);
ALTER TABLE pessoa ADD CONSTRAINT fk_pessoa_cidade FOREIGN KEY (endereco_codigo_cidade) REFERENCES cidade(codigo);

UPDATE pessoa SET endereco_codigo_cidade = 2;